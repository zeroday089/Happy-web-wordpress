...
export const calendlyUrlMap: Record<string, string> = {
  // Tarot Guidance
  "Jwalant S.|Tarot Guidance": "https://calendly.com/devyashrasela/new-meeting",
  "Nona|Tarot Guidance": "https://calendly.com/devyashrasela/new-meeting",
  "Saachi A.|Tarot Guidance": "https://calendly.com/devyashrasela/new-meeting",
  ...
  "Pritpal|Energy Healing": "https://calendly.com/devyashrasela/new-meeting",

  // Astrology
  "Monika|Astrology": "https://calendly.com/devyashrasela/new-meeting",

  // Numerology
  "Saachi A.|Numerology": "https://calendly.com/devyashrasela/new-meeting",

  // Name Correction
  "Saachi A.|Name Correction": "https://calendly.com/devyashrasela/new-meeting",

  // Conscious Guidance
  "Pooja|Conscious Guidance": "https://calendly.com/devyashrasela/meditation-session",

  // Meditation
  "Jwalant S.|Meditation": "https://calendly.com/devyashrasela/new-meeting",

  // Vastu
  "Saachi A.|Vastu": "https://calendly.com/devyashrasela/new-meeting",
};
